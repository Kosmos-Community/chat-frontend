    ...
    <main className="text-sm w-full h-screen flex justify-center items-center">
      <div className="w-full h-full flex flex-col overflow-hidden">
        <div className="text-xs p-2 px-3 bg-stone-800 flex justify-between items-center">
          ...
          <button
            title="logout"
            className="text-stone-400 hover:text-red-500 focus:text-red-500 w-8 h-8 hover:bg-red-500/25 focus:bg-red-500/25 rounded-md flex justify-center items-center transition outline-none"
